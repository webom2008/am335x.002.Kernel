...
static void tsc_step_config(struct tscadc *ts_dev)
{
	...
	case 4:
		...
		stepconfigx |= TSCADC_STEPCONFIG_INP_AN2 | TSCADC_STEPCONFIG_XPP | TSCADC_STEPCONFIG_XNN;
		//stepconfigx |= TSCADC_STEPCONFIG_INP_AN2 | TSCADC_STEPCONFIG_XNP | TSCADC_STEPCONFIG_YNN;
		//stepconfigx |= TSCADC_STEPCONFIG_INM_ADCREFM | (0<<19) | TSCADC_STEPCONFIG_XNP | TSCADC_STEPCONFIG_YNN;
		break;
	case 5:
	...
	case 4:
		...
		stepconfigy |= TSCADC_STEPCONFIG_INM_ADCREFM | TSCADC_STEPCONFIG_YPP | TSCADC_STEPCONFIG_YNN;
		//stepconfigy |= TSCADC_STEPCONFIG_INM_ADCREFM | TSCADC_STEPCONFIG_XPP | TSCADC_STEPCONFIG_YPN;
		//stepconfigy |= (3<<19) | TSCADC_STEPCONFIG_XPP | TSCADC_STEPCONFIG_YPN;
		break;
	case 5:
